...
import {
  ...
  Sparkles, DollarSign, Eye, Recycle, Bookmark as BookmarkIcon, MapPin,
    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-5">
          ...
          <MetricCard icon={DollarSign}   label="Value Recovered" value={`$${(m.valueRecovered ?? 0).toLocaleString()}`}              accent="green"  />
