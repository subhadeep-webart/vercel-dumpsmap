    ...
    <div className="min-h-[100dvh] bg-neutral-50">
      ...
      <section className="container mx-auto px-4 pb-6">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <StatTile icon={CircleDollarSign} label="Dump cost"              value={hasData ? fmtUSD(month.totalCost) : '—'} sub={hasData && month.avgCostPerTon ? `~${fmtUSD(month.avgCostPerTon)}/ton` : 'With env-fees'} />
