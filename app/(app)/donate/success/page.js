...
// Header comes from the (app) route-group layout. This page keeps its own
// gradient background wrapper (the group layout's default bg is neutral-50).
function Inner() {
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-to-br from-neutral-50 via-white to-brand-50">
      <Breadcrumbs items={[{ label: 'Donate', href: '/donate' }, { label: 'Thank you' }]} maxWidth="max-w-xl" />
      <div className="container mx-auto max-w-xl px-4 py-6 sm:py-8">
