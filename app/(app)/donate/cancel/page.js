...
// Header comes from the (app) route-group layout. This page supplies only its
// breadcrumb row + content container (previously provided by PageShell).
export default function DonateCancelPage() {
  const router = useRouter()
  return (
    <>
      <Breadcrumbs items={[{ label: 'Donate', href: '/donate' }, { label: 'Cancelled' }]} maxWidth="max-w-md" />
      <div className="container mx-auto max-w-md px-4 py-6 sm:py-8">
