...
// ------------------------------------------------------------
// Icons for facility types and statuses live in lib/facility-icons.jsx (lucide
// components), keyed by the `value` slugs below — kept out of this file so the
// config stays plain, React-free data (buildAutoTags etc. read it server-side).
export const FACILITY_STATUS_OPTIONS = [
  { value: 'open',                label: 'Open',                          color: 'green' },
  { value: 'closed',              label: 'Closed',                        color: 'red' },
  { value: 'full',                label: 'Full / Turning away loads',     color: 'red' },
  { value: 'moving_fast',         label: 'Moving Fast',                   color: 'green' },
  { value: 'long_wait',           label: 'Long Wait',                     color: 'amber' },
  { value: 'appointment',         label: 'Appointment Required',          color: 'blue' },
  { value: 'scale_down',          label: 'Scale Down',                    color: 'red' },
  { value: 'partial_accept',      label: 'Not Accepting Certain Materials', color: 'amber' },
]
