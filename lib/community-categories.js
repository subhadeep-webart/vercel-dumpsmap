...
export const REACTION_TYPES = [
  { key: 'helpful', icon: '👍', label: 'Helpful' },
  { key: 'thanks', icon: '🙏', label: 'Thanks' },
  { key: 'concern', icon: '⚠️', label: 'Concern' },
  { key: 'onit', icon: '🚚', label: 'On it' },
...
export const PROFILE_TYPES = [
  { key: 'resident',         label: 'Resident',         icon: '🏠', color: 'neutral' },
  { key: 'contractor',       label: 'Contractor',       icon: '👷', color: 'orange' },
  { key: 'hauler',           label: 'Hauler',           icon: '🚚', color: 'blue' },
  { key: 'recycler',         label: 'Recycler',         icon: '♻️', color: 'green' },
  { key: 'facility_owner',   label: 'Facility Owner',   icon: '🏭', color: 'purple' },
  { key: 'realtor',          label: 'Realtor',          icon: '🏘️', color: 'cyan' },
  { key: 'property_manager', label: 'Property Manager', icon: '🏢', color: 'slate' },
  { key: 'volunteer',        label: 'Volunteer',        icon: '🤝', color: 'lime' },
  { key: 'business',         label: 'Business',         icon: '💼', color: 'amber' },
  { key: 'agency',           label: 'Local Agency',     icon: '🏛️', color: 'red' },
]
