...
export default function BusinessTab({ form, setForm, save, saving }) {
  return (
    <ProfileCard title="Business information" desc="Your bio, company, and business details" icon={Briefcase}>
      ...
      <FieldRow label="Company name" icon={Briefcase}>
        <Input className={profileInputClass} value={form.companyName} onChange={(e) => setForm({ ...form, companyName: e.target.value })}
      ...
      <FieldRow label="Website" icon={Globe}>
        <Input className={profileInputClass} value={form.website} onChange={(e) => setForm({ ...form, website: e.target.value })}
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <FieldRow label="Business type" icon={Briefcase} note="LLC, Sole Prop, Corp, etc.">
          <Input className={profileInputClass} value={form.businessType} onChange={(e) => setForm({ ...form, businessType: e.target.value })}
        ...
        <FieldRow label="EIN (optional)" icon={Lock} note="Required for verified business status">
          <Input className={profileInputClass} value={form.ein} onChange={(e) => setForm({ ...form, ein: e.target.value })}
