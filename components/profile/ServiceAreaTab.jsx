...
export default function ServiceAreaTab({ form, setForm, save, saving }) {
  ...
  return (
    <ProfileCard title="Service area" desc="Where you work and the areas you cover" icon={MapPin}>
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <FieldRow label="Service radius (miles)" note="0-500">
          <Input className={profileInputClass} type="number" min={0} max={500} value={form.serviceAreaRadiusMi}
      ...
      <FieldRow label="ZIP codes you cover" note="Press Enter or click Add">
        <div className="flex gap-2">
          <Input className={profileInputClass} value={zipDraft} onChange={(e) => setZipDraft(e.target.value)}
      ...
      <FieldRow label="Preferred work zones" note="Neighbourhoods or named areas you prefer">
        <div className="flex gap-2">
          <Input className={profileInputClass} value={zoneDraft} onChange={(e) => setZoneDraft(e.target.value)}
